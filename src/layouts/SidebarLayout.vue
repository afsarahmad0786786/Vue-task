  ...
  <div class="sidebar-layout">
    ...
    <Sidebar :theme="props.theme" :is-open="isDesktopSidebarOpen">
      <template #links>
        ...
        <!-- Components -->
        <li>
          <a :class="[activeMobileSubsidebar === 'components' && 'is-active']" data-content="Components"
            aria-label="View components" tabindex="0" @keydown.space.prevent="switchSidebar('components')"
